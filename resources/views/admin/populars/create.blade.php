...
@section('title', 'Create new popular')

@section('pageTitle', 'Create Popular')
@push('style')
...
<div class="p-3">
    <form action="{{ route('admin.popular.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-35">
                <input type="text" id="cname" name="popular" placeholder="Popular name..">
                @error('popular')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
            <div class="col-25">
                <label for="fname">Popular Name Bangla</label>
            </div>
            <div class="col-35">
                <input type="text" id="cnameBangla" name="countryBangla" placeholder="Popular name in bangla..">
                @error('countryBangla')
                <p class="text-danger">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="row">
            ...
            <div class="col-25">
                <label for="banner">Select Banner 1</label>
            </div>
            <div class="col-35 pt-2">
        ...
        <div class="row mt-2">
            ...
            <div class="col-75">
                <textarea id="contentBangla" name="contentBangla"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-25">
