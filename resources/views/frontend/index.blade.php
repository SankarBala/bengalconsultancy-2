        ...
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-7">
                <div class="dreamit-slider-content text-dark">
                    ...
                    <p class="text-success" style="font-size:16px; width:100%; text-align:justify;"> {{ trans('home.agent') }}
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 mt-2">
                ...
                <div class="about-buttons text-center">
                    <a class="btn appointment-button" href="{{ route('contactUs') }}">{{ trans('home.getAppointment') }} <i
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="dreamit-slider-content text-dark">
                    ...
                    <p class="text-success" style="font-size:16px; width:100%; text-align:justify;">
                        {{ trans('home.agent2') }}</p>
                </div>
            </div>
        ...
        <div class="container mb-4 pb-5">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="text-justify text-white p-3" style="background-color: rgb(11, 147, 11);">
