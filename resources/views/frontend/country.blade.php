...
@section('content')
<div class="breatcome-area d-flex align-items-center" style="background-image: url('{{ Storage::url($sCountry->banner) }}');">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="assesstment-form-box p-0 mt-4 ">
                        ...
                        <form action="{{ route('postQuery') }}" method="POST" enctype="multipart/form-data" class="text-left">
                            ...
                            <div class="row mt-20">
                                ...
                                <div class="col-lg-12">
                                    <input class="btn btn-danger w-100 country-sliders py-2 mt-1" type="submit" value="{{trans('contact.send')}}">
